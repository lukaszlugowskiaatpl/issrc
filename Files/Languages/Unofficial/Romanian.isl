...
; Translator : Alexandru Bogdan Munteanu (muntealb@gmail.com) and Łukasz Ługowski (lukasz.lugowski@aat.pl)
;
...
; *** Startup questions
PrivilegesRequiredOverrideTitle=Selectați modul de instalare a configurării
PrivilegesRequiredOverrideInstruction=Selectați modul de instalare
PrivilegesRequiredOverrideText1=%1 poate fi instalat pentru toți utilizatorii (necesită privilegii administrative) sau numai pentru dvs.
PrivilegesRequiredOverrideText2=%1 poate fi instalat numai pentru dvs. sau pentru toți utilizatorii (necesită privilegii administrative).
PrivilegesRequiredOverrideAllUsers=Instalare pentru &toti utilizatorii
PrivilegesRequiredOverrideAllUsersRecommended=Instalați pentru &toți utilizatorii (recomandat)
PrivilegesRequiredOverrideCurrentUser=Instalați numai pentru &mine
PrivilegesRequiredOverrideCurrentUserRecommended=Instalați numai pentru &mine (recomandat)
...
DownloadingLabel=Se descarcă fișiere suplimentare ...
ButtonStopDownload=&Opriți descărcarea
StopDownload=Sigur doriți să opriți descărcarea?
ErrorDownloadAborted=Descărcarea a fost anulată
ErrorDownloadFailed=Descarcare esuata: %1 %2
ErrorDownloadSizeFailed=Obținerea dimensiunii a eșuat: %1 %2
ErrorFileHash1=Fișierul hash a eșuat: %1
ErrorFileHash2=Hash de fișier nevalid: așteptat %1, găsite %2
ErrorProgress=Progres nevalid: %1 de %2
ErrorFileSize=Dimensiune nevalidă a fișierului: așteptat %1, găsite %2
...
PrepareToInstallNeedsRestart=Configurarea trebuie să reporniți computerul. După repornirea computerului, rulați din nou instalarea pentru a finaliza instalarea [nume].%n%nDoriți să reporniți acum?
...
AbortRetryIgnoreSelectAction=&Încearcă din nou 
AbortRetryIgnoreRetry=&Pokušaj opet
AbortRetryIgnoreIgnore=&Ignorați eroarea și continuați
AbortRetryIgnoreCancel=Anulați instalarea
...
; *** File copying errors
FileAbortRetryIgnoreSkipNotRecommended=&Omiteți acest fișier (nerecomandat)
FileAbortRetryIgnoreIgnoreNotRecommended=&Ignorați eroarea și continuați (nerecomandat)
SourceIsCorrupted=Fila sursă este stricată (coruptă)
SourceDoesntExist=Fila sursă "%1" nu există
ExistingFileReadOnly2=Fișierul existent nu a putut fi înlocuit deoarece este marcat numai în citire.
ExistingFileReadOnlyRetry=&Eliminați atributul numai în citire și încercați din nou
ExistingFileReadOnlyKeepExisting=&Păstrați fișierul existent
ErrorReadingExistingDest=A apărut o eroare în timpul citirii filei deja existente:
FileExistsSelectAction=Selectați acțiunea
FileExists2=Fișierul există deja.
FileExistsOverwriteExisting=&Suprascrieți fișierul existent
FileExistsKeepExisting=&Păstrați fișierul existent
FileExistsOverwriteOrKeepAll=&Faceți acest lucru pentru următoarele conflicte
ExistingFileNewerSelectAction=Selectați acțiunea
ExistingFileNewer2=Fișierul existent este mai nou decât cel pe care încearcă instalarea.
ExistingFileNewerOverwriteExisting=&Suprascrieți fișierul existent
ExistingFileNewerKeepExisting=&Păstrați fișierul existent (recomandat)
ExistingFileNewerOverwriteOrKeepAll=&Faceți acest lucru pentru următoarele conflicte
