...
;
; Translated by Rancher (theranchcowboy@gmail.com) and Davor (davornik@yahoo.com), Update encoding By Łukasz_Ł. (lukasz.lugowski@aat.pl).
;
...
OnlyOnTheseArchitectures=Program se može instalirati samo na izdanjima Windows-a koji rade na sledeaim arhitekturama procesora:%n%n%1
...
; *** Startup questions
PrivilegesRequiredOverrideTitle=Odaberite naein instalacije
PrivilegesRequiredOverrideInstruction=Odaberite naein instalacije
...
PrivilegesRequiredOverrideAllUsersRecommended=Instaliraj za &sve korisnike (preporueeno)
PrivilegesRequiredOverrideCurrentUser=Instaliraj samo za &mene
PrivilegesRequiredOverrideCurrentUserRecommended=Instaliraj samo za &mene (preporueeno)
...
SelectLanguageLabel=Izaberite jezik za korišaenje tokom instalacije:
...
ErrorDownloadSizeFailed=Dobijanje velieine nije uspelo: %1 %2
ErrorFileHash1=Heš datoteke nije uspeo: %1
ErrorFileHash2=Neispravan heš datoteke: oeekivan %1, prona?en %2
ErrorProgress=Neispravan napredak: %1 od %2
ErrorFileSize=Neispravna velieina datoteke: oeekivan %1, prona?en %2
...
PrepareToInstallNeedsRestart=Instalacija mora da ponovo pokrene raeunar. Nakon ponovnog pokretanja raeunara, ponovo pokrenite instalaciju da biste dovršili instalaciju [name].%n%nŽelite li da ponovo pokrenete raeunar sada?
...
; *** File copying errors
FileAbortRetryIgnoreSkipNotRecommended=&Preskoeite ovu datoteku (ne preporueuje se)
FileAbortRetryIgnoreIgnoreNotRecommended=&Zanemari grešku i nastavi (ne preporueuje se)
SourceIsCorrupted=Izvorna datoteka je ošteaena
SourceDoesntExist=Izvorna datoteka „%1“ ne postoji
ExistingFileReadOnly2=Postojeća datoteka ne može da se zameni jer je samo za eitanje.
ExistingFileReadOnlyRetry=&Uklonite atribut samo za eitanje i pokušajte ponovo
ExistingFileReadOnlyKeepExisting=&Zadržite postojeau datoteku
ErrorReadingExistingDest=Došlo je do greške pri pokušaju eitanja postojeće datoteke:
FileExistsSelectAction=Odaberi akciju
FileExists2=Datoteka već postoji.
FileExistsOverwriteExisting=&Zameni postojeće datoteku
FileExistsKeepExisting=&Zadrži postojeće datoteku
FileExistsOverwriteOrKeepAll=&Uradi ovo i ubuduae
ExistingFileNewerSelectAction=Odaberi akciju
ExistingFileNewer2=Postojeaa datoteka je novija od one koju treba instalirati.
ExistingFileNewerOverwriteExisting=&Zameni postojeće datoteku
ExistingFileNewerKeepExisting=&Zadrži postojeće datoteku (preporueeno)
ExistingFileNewerOverwriteOrKeepAll=&Uradi ovo i ubuduae
ErrorChangingAttr=Došlo je do greške pri izmeni osobine sledeae datoteke:
